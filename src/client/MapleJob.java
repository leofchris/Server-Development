...
public enum MapleJob {
    ...
    EVAN(2001),
    EVAN1(2200),EVAN2(2210),EVAN3(2211),EVAN4(2212),EVAN5(2213),EVAN6(2214),EVAN7(2215),EVAN8(2216),EVAN9(2217),EVAN10(2218),
    
    BLADERECRUIT(430),
    BLADEACOLYTE(431),BLADESPECIALIST(432),BLADELORD(433),BLADEMASTER(434),
    
    CITIZEN(3000),
    MECHANIC1(3500),MECHANIC2(3510),MECHANIC3(3511),MECHANIC4(3512),
    WILDHUNTER1(3300),WILDHUNTER2(3310),WILDHUNTER3(3311),WILDHUNTER4(3312),
    BATTLEMAGE1(3200),BATTLEMAGE2(3210),BATTLEMAGE3(3211),BATTLEMAGE4(3212);
